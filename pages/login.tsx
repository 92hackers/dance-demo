            ...
            <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
              ...
              <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200 shadow-md">
                <div className="px-5 py-7">
                  ...
                  <input type="text" className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
                  <button type="button" className="transition duration-200 bg-[#c00] hover:bg-[#e00] focus:shadow-sm focus:ring-4 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
                  ...
                  <div className="grid grid-cols-2 gap-1">
                    <div className="text-center sm:text-left whitespace-nowrap">
                      <button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                        ...
                        <span className="inline-block ml-1">忘记密码？</span>
                      </button>
                    </div>
                  </div>
                </div>
